...
class CertificateApp:
    def __init__(self, root):
        ...
        self.container.place(relx=0.5, rely=0.5, anchor="center", width=700, height=600)

        # Title
        self.title = tk.Label(self.container, text="Blockchain Based Certificate Validation", font=("Arial", 26, "bold"), bg=self.root["bg"], fg="blue")
        ...
        button_style = {"bg": "red", "fg": "white", "font": ("Arial", 14, "bold"), "width": 20, "height": 2}
